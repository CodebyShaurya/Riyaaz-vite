...
export default function Navbar() {
  ...
  return (
    <header className="bg-[#08192d] z-10 text-white sticky">
      <nav
      ...
      >
        <div className="flex lg:flex-1">
          <Link to="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-16 w-auto" src={logo} alt="Riyaaz" />
          </Link>
        </div>
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#08192d]  px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
