          ...
          <div className='pr-28 text-lg'>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
            ...
            <div className='grid grid-cols-4 px-32 py-20  content-center'>
                  ...
                  <div className='content-center text-center'>
                      ...
                      <div className='pr-10 text-xl font-bold'>Soul Music</div>
                  </div>
                  <div className='content-center text-center'>
                      <img src={pic2}  className='rounded-3xl'/>
                      <div className='pr-10 text-xl font-bold'>Live Concert</div>
                  </div>


                  <div className='content-center text-center'>
                      <img src={pic3}  className='rounded-3xl'/>
                      <div className='pr-10 text-xl font-bold'>Dj Sets</div>
                  </div>

                  <div className='content-center text-center'>
                      <img src={pic4}  className='rounded-3xl'/>
                      <div className='pr-10 text-xl font-bold'>Live Streams</div>
                  </div>
        ...
        <div className='bg-[#0a183d]  pt-16 pb-10 text-white'>
            ...
            <div className='grid grid-cols-2 px-32 py-10  content-center'>
              ...
              <div className='mx-10 bg-[#1c294a] rounded-3xl pt-16 pb-10 pl-32'>
                <ul>
                  <li className='flex'> <img src={bullet}/> <div className='pl-6 py-2 text-xl'>Play any track</div> </li>
                  <li className='flex pt-2'> <img src={bullet}/> <div className='pl-6 py-2 text-xl'>Listen offline</div> </li>
                  <li className='flex pt-2'> <img src={bullet}/> <div className='pl-6 py-2 text-xl'>No ad interruptions</div> </li>
                  <li className='flex pt-2'> <img src={bullet}/> <div className='pl-6 py-2 text-xl'>Unlimited skips</div> </li>
                  <li className='flex pt-2'> <img src={bullet}/> <div className='pl-6 py-2 text-xl'>High quality audio</div> </li>
                  <li className='flex pt-2'> <img src={bullet}/> <div className='pl-6 py-2 text-xl'>Shuffle play</div> </li>
                </ul>
              </div>
